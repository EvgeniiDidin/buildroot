...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'ANDROID_API_LEVEL': 0,
 'AR': '/opt/arc_gnu/bin/arc-linux-ar',
 'ARFLAGS': 'rc',
 ...
 'BLDSHARED': '/opt/arc_gnu/bin/arc-linux-gcc '
              '-shared',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': '/opt/arc_gnu/bin/arc-linux-gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-Wstrict-prototypes -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
           '-D_FILE_OFFSET_BITS=64 -matomic -Os',
 ...
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--target=arc-buildroot-linux-gnu' "
                ...
                "'--with-expat=system' '--enable-ossaudiodev' "
                ...
                "-D_FILE_OFFSET_BITS=64 -matomic -Os ' 'LDFLAGS=' "
                "'CPPFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE "
                "-D_FILE_OFFSET_BITS=64' "
                "'CPP=/opt/arc_gnu/bin/arc-linux-cpp' "
                "'PKG_CONFIG=/home/didin/work/tmp/Tensorflow_build_flow/buildroot/output/host/bin/pkg-config'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.6m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/home/didin/work/tmp/Tensorflow_build_flow/buildroot/output/build/python3-3.6.3/coverage.info',
 'COVERAGE_REPORT': '/home/didin/work/tmp/Tensorflow_build_flow/buildroot/output/build/python3-3.6.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
             '-D_FILE_OFFSET_BITS=64',
 'CXX': '/opt/arc_gnu/bin/arc-linux-g++',
 ...
 'DFLAGS': '',
 'DIRMODE': 755,
 'DISABLED_EXTENSIONS': 'nis _tkinter',
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'arc-buildroot-linux-gnu',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/opt/arc_gnu/bin/arc-linux-g++ '
                '-shared',
 'LDFLAGS': '',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.6m.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/opt/arc_gnu/bin/arc-linux-gcc '
             '-shared',
 'LDVERSION': '3.6m',
 'LIBC': '',
 ...
 'LIBPL': '/usr/lib/python3.6/config-3.6m',
 'LIBRARY': 'libpython3.6m.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl  -lpthread -lutil',
 'LIBSUBDIRS': 'site-packages \\',
 'LINKCC': '/opt/arc_gnu/bin/arc-linux-gcc',
 ...
 'MAINCC': '/opt/arc_gnu/bin/arc-linux-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'PYTHONPATH': ':',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/didin/work/tmp/Tensorflow_build_flow/buildroot/output/build/python3-3.6.3 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/didin/work/tmp/Tensorflow_build_flow/buildroot/output/build/python3-3.6.3/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -matomic -Os '
 ...
 'RANLIB': '/opt/arc_gnu/bin/arc-linux-ranlib',
 'READELF': '/opt/arc_gnu/bin/arc-linux-readelf',
 ...
 'abs_builddir': '/home/didin/work/tmp/Tensorflow_build_flow/buildroot/output/build/python3-3.6.3',
 'abs_srcdir': '/home/didin/work/tmp/Tensorflow_build_flow/buildroot/output/build/python3-3.6.3',
